...
CREATE EXTERNAL TABLE IF NOT EXISTS covid_reporting_lookup.dim_date (
   ...
   STORED AS TEXTFILE
   LOCATION 'abfs://lookup@storecovid19reportdata.dfs.core.windows.net/dim_date/'
   TBLPROPERTIES ("skip.header.line.count"="1");

DROP TABLE IF EXISTS covid_reporting_lookup.country_lookup;

CREATE EXTERNAL TABLE IF NOT EXISTS covid_reporting_lookup.country_lookup (
   country STRING,
   ...
   ROW FORMAT DELIMITED FIELDS TERMINATED BY ','
   STORED AS TEXTFILE
   LOCATION 'abfs://lookup@storecovid19reportdata.dfs.core.windows.net/country_lookup/'
   TBLPROPERTIES ("skip.header.line.count"="1");
...
CREATE EXTERNAL TABLE IF NOT EXISTS covid_reporting_raw.testing (
   ...
   ROW FORMAT DELIMITED FIELDS TERMINATED BY ','
   STORED AS TEXTFILE
   LOCATION 'abfs://raw@storecovid19reportdata.dfs.core.windows.net/ecdc/testing/'
   TBLPROPERTIES ("skip.header.line.count"="1");
...
CREATE TABLE IF NOT EXISTS covid_reporting_processed.testing (
   ...
   ROW FORMAT DELIMITED FIELDS TERMINATED BY ','
   STORED AS TEXTFILE
   LOCATION 'abfs://processed@storecovid19reportdata.dfs.core.windows.net/ecdc/testing'
   TBLPROPERTIES ("skip.header.line.count"="1");
...
JOIN covid_reporting_lookup.country_lookup c
